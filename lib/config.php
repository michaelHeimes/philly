...
function roots_main_class() {
  if (roots_display_sidebar()) {
    ...
    $class = 'small-12 large-7 large-offset-1 medium-8 medium-push-4';
  } else {
...
function roots_sidebar_class() {
  return apply_filters('roots/sidebar_class', 'small-12 medium-4 medium-pull-8');
}
...
function roots_display_sidebar() {
  $sidebar_config = new Roots_Sidebar(
    ...
    array(
      'is_404',
      'is_front_page',
      array('is_page', array('header-footer')),
    ),
    /**
